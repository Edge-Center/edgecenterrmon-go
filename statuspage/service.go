...
type Service interface {
	...
	Get(ctx context.Context, pageId int) (*Response, error)
	Update(ctx context.Context, pageId int, req *Request) error
	Delete(ctx context.Context, pageId int) error
}
...
func (s *service) Create(ctx context.Context, req *Request) (*CreateResponse, error) {
	...
	u := url.URL{Path: "/rmon/status-page"}
...
func (s *service) Get(ctx context.Context, pageId int) (*Response, error) {
	var resp Response

	u := url.URL{
		Path: fmt.Sprintf("/rmon/status-page/%d", pageId),
	}
...
func (s *service) Update(ctx context.Context, pageId int, req *Request) error {
	u := url.URL{
		Path: fmt.Sprintf("/rmon/status-page/%d", pageId),
	}
...
func (s *service) Delete(ctx context.Context, pageId int) error {
	u := url.URL{
		Path: fmt.Sprintf("/rmon/status-page/%d", pageId),
	}
